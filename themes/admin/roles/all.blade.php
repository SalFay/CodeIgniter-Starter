...
@section('content')
    <div class="box" id="role-overview">
        <div class="box-header with-border">
            <h3 class="box-title">User Roles</h3>

            <div class="btn-group btn-group-xs pull-right">
                <button type="button" class="btn btn-success btn-xs" id="add-new">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#add-new').on('click', function () {
                ...
                $('#role-edit .box-title').html('Add Role');
            ...
            .on('click', '[data-action="edit"]', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.status === 'ok') {
                            var role = data.role;
                            $('#role-edit .box-title').html('Edit Role - ' + role.name);
